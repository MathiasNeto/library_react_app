...
const TelaFormulario = () => {
    ...
    /*     const handlePeriodoCursoChange = (event) => {
            setPeriodoCurso(event.target.value);
        };
        ...
        const handleEnderecoChange = (event, field) => {
        ...
        const handleContatoChange = (event, index) => {
            const { id, value } = event.target;
            const field = id.includes('Tipo') ? 'tipo' : 'email';
    
            setContatos((prevState) => {
                const updatedContatos = [...prevState];
        ...
        const adicionarContato = () => {
            setContatos((prevState) => [...prevState, { tipo: '', valor: '' }]);
        };
        ...
        const handleCursoChange = (event, field) => {
            const { value } = event.target;
